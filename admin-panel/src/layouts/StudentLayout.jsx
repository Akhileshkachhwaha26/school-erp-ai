...
import {
  ...
  BookOpen, FileText, Megaphone, MessageCircle,
  Sparkles, LogOut, Library, CalendarOff
} from "lucide-react";
...
const navItems = [
  ...
  { to: "/student/materials", label: "Study Materials", icon: Library },
  { to: "/student/notices", label: "Notices", icon: Megaphone },
  { to: "/student/leave", label: "Leave Application", icon: CalendarOff },
  { to: "/student/doubt-solver", label: "AI Doubt Solver", icon: Sparkles },
      ...
      <aside className="flex w-64 shrink-0 flex-col border-r border-slate-200 bg-white">
        <div className="flex items-center gap-2.5 px-6 py-6 border-b border-slate-100">
          ...
          <div>
            ...
            <p className="text-[10px] uppercase tracking-wide text-slate-400">Student Portal</p>
          </div>
        </div>
            ...
            <NavLink key={to} to={to}
              className={({ isActive }) =>
                `flex items-center gap-3 rounded-xl px-4 py-2.5 text-sm font-medium transition ${
                  isActive ? "bg-emerald-50 text-emerald-700 shadow-sm" : "text-slate-500 hover:bg-slate-50 hover:text-slate-800"
                }`
              }
            >
        ...
        <div className="border-t border-slate-100 p-4">
          <div className="mb-2 flex items-center gap-2.5 rounded-xl bg-slate-50 px-3 py-2.5">
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-[11px] text-slate-400 capitalize">Student</p>
            </div>
          </div>
